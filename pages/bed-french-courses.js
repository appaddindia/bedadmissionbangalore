  ...
  return (
    <Layout>
      <Head>
        ...
        />
        <meta name="title" content="B.Ed in French in Bangalore" />
        <meta
          name="description"
          content="Want a B.Ed degree in French? Then you are in the right place. Feel free to contact us today. Enroll today."
        />
      </Head>
      <Bannerforservice
        name={data?.title}
...
export default Bedfrenchcourses;
