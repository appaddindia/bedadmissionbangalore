  ...
  (exports.modules = {
    4003: (e, l, s) => {
      ...
      var i = s(997),
        a = s(6859),
        c = s.n(a);
      let MyDocument = class MyDocument extends c() {
        static async getInitialProps(e) {
          let l = await c().getInitialProps(e);
          return { ...l };
        }
        render() {
          return (0, i.jsxs)(a.Html, {
            lang: "en",
            children: [
              i.jsx(a.Head, {}),
              (0, i.jsxs)("body", {
                children: [i.jsx(a.Main, {}), i.jsx(a.NextScript, {})],
              }),
            ],
          });
        }
    ...
    6325: (e, l, s) => {
                  ...
                  i.jsx("div", {
                    ...
                    children: (0, i.jsxs)("div", {
                      ...
                      children: [
                        ...
                        i.jsx("p", {
                          children:
                            "We proudly uphold our commitment to shaping the future of education through the provision of comprehensive B.Ed. training programs.",
                        }),
                      ],
                    }),
                  }),
                        ...
                        (0, i.jsxs)("ul", {
                          ...
                          children: [
                            i.jsx("li", {
                              children: i.jsx(n(), {
                                href: "/admission",
                                children: "Professional Qualification",
                              }),
                            }),
                            i.jsx("li", {
                              children: i.jsx(n(), {
                              ...
                              children: [
                                ...
                                i.jsx("span", {
                                  ...
                                  children: i.jsx("a", {
                                    ...
                                    href: `
                https://api.whatsapp.com/send?phone=9538861888&text=${e}`,
                            ...
                            i.jsx("label", { className: "form-notification" }),
                          ],
                        }),
                      ],
                    }),
                  ...
                  children: [
                    i.jsx("div", {
                      ...
                      children: i.jsx("ul", {
                        ...
                        children: i.jsx("li", {
                          children: i.jsx("a", {
                            href: "https://www.appaddindia.com/",
                            children:
                              "\xa9 B.Ed Admission in Bangalore University design by appaddindia.com",
                          }),
                        }),
                      }),
                    }),
      ...
      let layout_Footer2 = () =>
        ...
        layout_Header = ({ headerBtn: e }) => {
          let [l, s] = (0, a.useState)(null),
            onClick = () => {
              let e = document.querySelector("body");
              e.classList.toggle("wsactive");
            };
          return i.jsx("header", {
            id: "header",
        ...
        layout_Layout = ({ children: e, footer: l, headerBtn: s }) => {
          (0, a.useEffect)(() => {
            (0, r.jd)(), window.addEventListener("scroll", r.Td);
          });
          let o = (0, a.useContext)(c.l),
            { video: n } = o;
          return (0, i.jsxs)("div", {
            className: "page",
            id: "page",
            children: [
              i.jsx(layout_Header, { headerBtn: s }),
              e,
              2 === l ? i.jsx(layout_Footer2, {}) : i.jsx(layout_Footer, {}),
            ],
          });
        };
    },
    7039: (e, l, s) => {
      ...
      let stickNav = () => {
          let e = window.scrollY,
            l = document.querySelector("#wsmainfull");
          l &&
            (e > 80 ? l.classList.add("scroll") : l.classList.remove("scroll"));
        },
        aTagClick = () => {
          let e = document.querySelectorAll("[href='#']");
